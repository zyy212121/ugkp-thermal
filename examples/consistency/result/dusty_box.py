...
for ax, ylabel, exact, numerical, color, marker in ((axes[0],r"$U_g$ ($\mathrm{m\,s^{-1}}$)","Ug_analytic_m_s","Ug_GPU_GKS_GKP_m_s","#C44E52","o"),(axes[1],r"$U_p$ ($\mathrm{m\,s^{-1}}$)","Up_analytic_m_s","Up_GPU_GKS_GKP_m_s","#4C72B0","s")):
