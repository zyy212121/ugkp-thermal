...
CASE = RESULTS.parent / "singleAluminaDrop" / "coldWall"
...
def main():
    ...
    with (RESULTS/"single_drop_temperature_comparison.csv").open("w", newline="", encoding="utf-8") as stream:
        fieldnames = (
    ...
    with (RESULTS/"single_drop_spreading_comparison.csv").open("w", newline="", encoding="utf-8") as stream:
        fieldnames = (
    ...
    with (RESULTS/"single_drop_comparison_metrics.csv").open("w", newline="", encoding="utf-8") as stream:
